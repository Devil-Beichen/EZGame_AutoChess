...
void UAITask_MoveToNode::RequestSuccess()
{
	...
	if(ChessMovementComponent&&ChessMovementComponent->OnMoveComplete.IsAlreadyBound(this,&UAITask_MoveToNode::PerformMove))
		ChessMovementComponent->OnMoveComplete.RemoveDynamic(this,&UAITask_MoveToNode::PerformMove);
